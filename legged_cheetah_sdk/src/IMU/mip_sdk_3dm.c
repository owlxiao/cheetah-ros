...
//! @param [in] u8 function_selector            - The model number of the
//! device.
//! @param [in,out] float *bias_vector		    - Pointer to array
//! containing input bias vector on write commands or to contain output bias
...
//! @param [in] u8 function_selector            - The model number of the
//! device.
//! @param [in,out] float *vector		        - Pointer to array
//! containing input hard iron vector on write commands or to contain output
//! hard iron vector on read commands.
//
//! @retval MIP_INTERFACE_ERROR  When there is a problem with the command format
//! or the\n
//!                              the device communications failed.\n
...
//! device.
//! @param [in,out] float *vector		        - Pointer to array
//! containing input soft iron 3x3 matrix on write commands or to contain output
//! soft iron 3x3 matrix on read commands.
//
//! @retval MIP_INTERFACE_ERROR  When there is a problem with the command format
//! or the\n
//!                              the device communications failed.\n
...
//! device.
//! @param [in,out] float *vector		        - Pointer to array
//! containing input Euler angles on write commands or to contain output Euler
//! angles on read commands.
//
//! @retval MIP_INTERFACE_ERROR  When there is a problem with the command format
//! or the\n
//!                              the device communications failed.\n
